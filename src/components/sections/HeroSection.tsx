      ...
      <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 flex flex-col justify-center space-y-8 z-10">
          <div className="space-y-2">
            ...
            >
              Menos inadimplência, menos risco fiscal e contratos sob controle.
              Um ecossistema inteligente que traz previsibilidade financeira e
          ...
          >
            <div>
              ...
              <div className="text-xl font-mono text-horizon-gold">-40%</div>
            </div>
            <div>
              <div className="text-xs font-mono text-muted-text mb-1">
                PREVISIBILIDADE
            ...
            <div>
              ...
              <div className="text-xl font-mono text-horizon-red">ZERO</div>
            </div>
          </div>
        </div>
